                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if(auth()->user()->role === 'admin')
                            ...
                            <x-nav-link :href="route('admin.facilities')" :active="request()->routeIs('admin.facilities')">
                                {{ __('Facilities') }}
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if(auth()->user()->role === 'admin')
                    ...
                    <x-responsive-nav-link :href="route('admin.reservations')"
                        :active="request()->routeIs('admin.reservations')">
                        {{ __('Reservations') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.facilities')" :active="request()->routeIs('admin.facilities')">
                        {{ __('Facilities') }}
                    </x-responsive-nav-link>
